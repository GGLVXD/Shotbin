  ...
  <div class="drawer-side is-drawer-close:overflow-visible">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
      ...
      <ul class="menu w-full grow">
        ...
        <!-- List item -->
        <li>
          <button onclick="document.location='/dashboard/files'" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Files">
            <!-- Settings icon -->
            <img src="/icons/folder.png" width="16" height="16">
            <span class="is-drawer-close:hidden">Files</span>
          </button>
        </li>
      </ul>
    </div>
