  <div class="drawer-side">
    ...
    <div class="flex min-h-full flex-col items-start bg-base-200 w-64">
        <a href="/" class="w-full px-4 py-4 text-center text-xl font-bold">Adminstator</a>
      <!-- Sidebar content -->
      <ul class="menu w-full grow">
        <!-- List item -->
        <li>
          <a href="/admin/" class="tooltip tooltip-right" data-tip="Homepage">
            <!-- Home icon -->
        ...
        <!-- List item -->
        <li>
          <a href="/admin/files" class="tooltip tooltip-right" data-tip="Files">
            <!-- Folder icon -->
            <img src="/icons/folder.png" width="16" height="16" alt="Files">
            <span>Files</span>
          </a>
        </li>
        <li>
